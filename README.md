...
```
bash <(curl -Ls https://raw.githubusercontent.com/lostsoul6/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/lostsoul6/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/lostsoul6/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
